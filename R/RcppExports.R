...
find_rotation_cpp <- function(parameter_transformations, restriction_specs, preserve_diag_logs_ = NULL, tolerance = 0.0) {
    .Call(`_bayesianVARs_find_rotation_cpp`, parameter_transformations, restriction_specs, preserve_diag_logs_, tolerance)
}
