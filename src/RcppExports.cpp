...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(out_of_sample(each, X_T_plus_1, PHI, U, facload, logvar_T, ahead, sv_mu, sv_phi, sv_sigma, sv_indicator, factor, LPL, Y_obs, LPL_subset, VoI, simulate_predictive, innovations));
    return rcpp_result_gen;
END_RCPP
}
// insample
